...
function extractFontSize(font) {
  if (typeof font !== "string") return 30;
...
function createTextTexture(gl, text, font = "bold 30px sans-serif", color = "#ffffff") {
  ...
  const textHeight = Math.ceil(extractFontSize(font) * 1.2);
...
class Media {
  ...
  update(scroll, direction) {
    ...
    if (this.bend === 0) {
      ...
      const bendMagnitude = Math.abs(this.bend);
      const radius = (halfViewport * halfViewport + bendMagnitude * bendMagnitude) / (2 * bendMagnitude);
...
class OglGalleryApp {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: "https://picsum.photos/seed/1/1000/700", text: "Bridge" },
      { image: "https://picsum.photos/seed/2/1000/700", text: "Desk Setup" },
      { image: "https://picsum.photos/seed/3/1000/700", text: "Waterfall" },
      { image: "https://picsum.photos/seed/4/1000/700", text: "City Lights" },
      { image: "https://picsum.photos/seed/5/1000/700", text: "Coastline" },
      { image: "https://picsum.photos/seed/6/1000/700", text: "Sunset" }
    ];
